                ...
                <table style="text-align: center;" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                       <button data-id_pengadaan="{{$p->id_pengadaan}}" data-nama_pengadaan="{{$p->nama_pengadaan}}" data-anggaran="{{$p->anggaran}}"data-toggle="modal" data-target="#pengajuanModal"class="btn-secondary detail"><i class="fas fa-plus"></i>
                         Ajukan
                       </button>
